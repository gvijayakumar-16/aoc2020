...
passwords.forEach(password => {
    ...
    let [minimumLength, maximumLength] = length.split('-');
    let numberOfOccurances = actualPassword.split(character).length - 1;
    if (numberOfOccurances >= minimumLength && numberOfOccurances <= maximumLength) validPasswords.push(password);
});
console.log("Part 1:")
